...
export const plans = [
  {
    ...
    featured: false,
    badge: 'Plano base',
    image: '/images/aventureiro-1.png',
    images: [
      '/images/aventureiro-1.png',
      '/images/aventureiro-2.png',
      '/images/aventureiro-3.png',
      '/images/aventureiro-4.png',
    ],
    ...
    pieceCount: 60,
    pieces: 'Aproximadamente 60 peças (incl. clips OpenLOCK)',
    specs: [
      '16 tiles de piso',
      '12 paredes',
      '12 colunas (I, L e O)',
  ...
  },
  {
    ...
    billingNote: 'Cobrado mensalmente · Cancele a qualquer momento',
    pieceCount: 93,
    pieces: 'Aproximadamente 93 peças (incl. clips OpenLOCK)',
    specs: [
      'Tudo do Aventureiro',
      '+ 20 tiles extras',
      '+ itens de decoração',
  ...
  },
  {
    ...
    featured: true,
    badge: 'Mais popular',
    image: '/images/lendario-1.png',
    images: [
      '/images/lendario-1.png',
      '/images/lendario-2.png',
      '/images/lendario-3.png',
      '/images/lendario-4.png',
    ],
    tagline: 'A experiência épica completa. Para mestres que não aceitam menos.',
    freight: '+ frete (calculado por CEP)',
    billingNote: 'Cobrado mensalmente · Cancele a qualquer momento',
    pieceCount: 132,
    pieces: 'Aproximadamente 132 peças (incl. clips OpenLOCK)',
    specs: [
      'Tudo do Herói',
      '+ 20 tiles extras',
      '+ Decoração premium',
    ...
    perks: [
      ...
      '3 miniaturas exclusivas em 25mm (guerreiro, mago e esqueleto)',
      'Voto no tema do próximo mês',
